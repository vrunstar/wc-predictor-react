  ...
  return (
    ...
    >
      <div className="h-full px-4 md:px-8 flex items-center justify-between">
        ...
        {/* CENTER: Nav links (horizontally centered on desktop) */}
        ...
        {/* RIGHT: Admin Shield Icon */}
        <div className="hidden md:flex items-center">
          <NavLink
            to="/admin"
            className={({ isActive }) => 
              `p-2 rounded-full border transition-all duration-150 ${
                isActive ? 'text-white bg-white/10 border-white/20' : 'text-[#aaa] border-transparent hover:text-white hover:bg-white/5'
              }`
            }
            title="Admin Panel"
          >
        ...
        <div className="flex items-center gap-2 md:hidden">
          <NavLink
            ...
            className={({ isActive }) => 
              `p-2 rounded-full border transition-all duration-150 ${
                isActive ? 'text-white bg-white/10 border-white/20' : 'text-[#aaa] border-transparent hover:text-white'
              }`
            }
          >
            <Shield size={18} />
