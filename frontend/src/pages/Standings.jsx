  ...
  if (standings.length === 0) {
    return (
      <div className="text-center py-24 bg-[#091424] border border-[#242424]/40 rounded-[10px] p-12">
        <div className="text-xl font-bold font-FUCB tracking-wider text-gray-400">NO STANDINGS AVAILABLE</div>
      </div>
    );
  }
        ...
        {sortedGroupNames.map((grpName) => {
          ...
          return (
            <div key={grpName} className="bg-[#091424] rounded-[10px] border border-[#242424]/40 p-[1rem_1.2rem] flex flex-col gap-2">
              ...
              {/* Column headers */}
              <div className="grid grid-cols-[1.5fr_0.6fr_0.6fr_0.6fr_0.6fr_0.6fr_0.6fr] text-[0.65rem] text-gray-500 tracking-[0.12em] uppercase font-FNR mb-1 px-1">
                <div>Team</div>
              ...
              <div className="flex flex-col gap-1">
                {teams.map((row) => {
                  ...
                  return (
                    <div
                      key={row.team_id}
                      className="grid grid-cols-[1.5fr_0.6fr_0.6fr_0.6fr_0.6fr_0.6fr_0.6fr] items-center p-1 py-[0.25rem] rounded hover:bg-white/5 text-[0.82rem] font-FNR text-gray-300 transition-colors duration-100"
                    >
                      ...
                      <div className="text-center font-FSEB text-base text-[#F0F0F0]">{row.points}</div>
                    </div>
                  );
                })}
              </div>
