...
export default function Admin() {
  ...
  return (
    <div className="w-full max-w-[500px] md:max-w-[800px] mx-auto flex flex-col gap-6">
      {/* Title */}
      <h1 className="font-hm_text text-[3rem] md:text-[5rem] tracking-wider text-[#F0F0F0] leading-none mb-2 text-center">
        ADMIN
      </h1>
      ...
      {!currentFx ? (
        ...
        <div className="bg-[#091424] border border-[#242424]/40 rounded-[10px] p-[1.1rem_1.4rem]">
          ...
          <div className="grid grid-cols-[30px_1fr_auto_1fr_30px] items-center gap-[0.6rem] w-full">
            ...
            <div className="font-hm_text text-2xl tracking-wider text-[#F0F0F0] leading-none">
              {homeCode}
            </div>
            <div className="text-center min-w-[90px]">
              <span className="font-inter text-xl font-semibold text-white tracking-widest leading-none">
                {koTime}
              </span>
            </div>
            <div className="font-hm_text text-2xl tracking-wider text-[#F0F0F0] leading-none text-right">
              {awayCode}
            </div>
            <div className="flex items-center justify-center">
              <img
          ...
          <form onSubmit={handleSubmitResult} className="mt-4 flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
                <label className="text-[0.7rem] text-[#999] tracking-wider font-semibold font-inter">
                  {homeCode} Goals
                </label>
                <input
                  type="number"
      ...
      <div className="grid grid-cols-2 gap-4 mt-2">
        <button
          ...
          className="bg-white text-black hover:bg-neutral-200 disabled:opacity-50 disabled:bg-white/50 disabled:text-black/50 rounded-[8px] p-3 font-semibold text-sm tracking-wider font-inter transition-all duration-150 shadow"
        >
        ...
        <button
          ...
          disabled={submitting}
          className="bg-[#091424] border border-[#242424]/40 hover:border-white/50 hover:text-white text-[#aaa] disabled:opacity-50 rounded-[8px] p-3 font-semibold text-sm tracking-wider font-inter transition-all duration-150"
        >
